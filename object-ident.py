...
classNames = []
classFile = "/Users/carloscaceres/Desktop/Object_Detection_Files/coco.names"
with open(classFile,"rt") as f:
    classNames = f.read().rstrip("\n").split("\n")

    
#This is to pull the information about what each object should look like
configPath = "/Users/carloscaceres/Desktop/Object_Detection_Files/ssd_mobilenet_v3_large_coco_2020_01_14.pbtxt"
weightsPath = "/Users/carloscaceres/Desktop/Object_Detection_Files/frozen_inference_graph.pb"
...
#Below is the never ending loop that determines what will happen when an object is identified.    
    while True:
        ...
        result, objectInfo = getObjects(img,0.72,0.3, objects = ['dog'])
        #print(objectInfo)
